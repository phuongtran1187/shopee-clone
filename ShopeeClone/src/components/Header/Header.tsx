      ...
      <div className='container'>
        <div className='flex justify-end'>
          <Popover
            ...
            className='flex cursor-pointer items-center py-1 hover:opacity-80'
          >
            <svg
          ...
          {isAuthentication && (
            <Popover
              className='ml-6 flex cursor-pointer items-center py-1 hover:opacity-80'
              renderPopover={
                <div className='relative rounded-sm bg-white shadow-sm'>
                  <Link
                    to={path.profile}
                    className='block w-full bg-white py-3 px-6 text-left hover:bg-slate-100 hover:text-green-500'
                  >
                    Tài khoản cá nhân
                  </Link>
                  <Link
          ...
          {!isAuthentication && (
            <div className='flex items-center'>
              <Link to={path.register} className='m-3 capitalize hover:text-white/70'>
                Đăng ký
              </Link>
              <div className='h-4 border-r-[1px] border-r-white/40'></div>
              <Link to={path.login} className='m-3 capitalize hover:text-white/70'>
                Đăng nhập
              </Link>
            </div>
          )}
        </div>
        <div className='items- mt-4 grid grid-cols-12 gap-4'>
          ...
          <form className='col-span-9' onSubmit={handleSubmitSearch}>
            <div className='flex rounded-sm bg-white p-1'>
              <input
                type='text'
                placeholder='Mua mọi thứ tại SHOPEE'
