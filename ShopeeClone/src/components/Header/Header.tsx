...
export default function Header() {
  const { isAuthentication, setIsAuthentication } = useContext(AppContext)
        ...
        <div className='flex justify-end'>
          ...
          {!isAuthentication && (
            <div className='flex items-center'>
              <Link to='/register' className='m-3 capitalize hover:text-white/70'>
                Đăng ký
              </Link>
              <div className='h-4 border-r-[1px] border-r-white/40'></div>
              <Link to='/login' className='m-3 capitalize hover:text-white/70'>
                Đăng nhập
              </Link>
            </div>
          )}
